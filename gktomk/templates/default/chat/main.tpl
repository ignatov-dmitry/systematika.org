...
<link rel="stylesheet" href="{*URL_SITE*}/templates/{*TPL_NAME*}/chat/assets/css/style.css?v=3">
        ...
        <div class="col-sm-4 side">
                ...
                <div class="row heading">
                    <div class="col-sm-3 col-xs-3 heading-avatar">
                        <div class="heading-avatar-icon">
                            <img src="{*URL_SITE*}/templates/default/chat/assets/images/chat-nophoto.png">
                        </div>
                    </div>
                    /*
            ...
            <div class="side-two">
                ...
                */
                ...
                <div class="row compose-sideBar scrollbar">
                    <div class="row sideBar-body">
                        <div class="col-sm-3 col-xs-3 sideBar-avatar">
                            <div class="avatar-icon">
        ...
        <div class="col-sm-8 conversation">
            <div class="row heading">
                ...
                <div class="col-sm-8 col-xs-7 heading-name">
                    ...
                    <p id="calladmin" style="color: #778072;padding: 0 5;"></p>
                </div>
            ...
            <div class="row reply" style="display: none;">
                ...
                <div class="col-sm-9 col-xs-9 reply-main">
                    ...
                    <textarea class="form-control" rows="1" name="message" id="dialogFormMessage" required="required" autofocus></textarea>
                </div>
